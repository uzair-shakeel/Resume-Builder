...
export default function CVPreviewMinimal({
  ...
  return (
    <div className="w-[210mm] h-[297mm] bg-white shadow-lg flex">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <h1 className="text-3xl font-light text-[#D91B81] mb-8">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {skills.map((skill, index) => (
              <div key={index} className="grid grid-cols-[140px_1fr]">
                <span className="text-[#D91B81] font-medium">{skill.name}</span>
                <span>
                  {skill.level === 5
                    ? "Excellent"
                    : skill.level === 4
